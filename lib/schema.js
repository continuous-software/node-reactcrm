module.exports = {
  ...
  "type": ["object"],
  "id": "https://api.funnels.io/public/schema.json",
  "links": [{"href": "https://api.funnels.io", "rel": "self"}],
  "title": "REACT CRM API",
  "properties": {
  ...
  "definitions": {
    ...
    "applications": {
      ...
      "links": [{
        ...
        "targetSchema": {
          "type": "object",
          "properties": {"token": {"type": "string"}, "campaignId": {"$ref": "#/definitions/campaigns/definitions/id"}}
        }
      }]
    },
    "areas": {
        ...
        "schema": {
          "anyOf": [{
            ...
            "properties": {
              ...
              "order": {
                "type": "object",
                "properties": {"amount": {"type": ["string", "number"]}, "currency": {"type": ["string", "null"]}}
              },
              "payment": {
                "type": "object",
                "properties": {
    ...
    "merchantProfiles": {
      ...
      "links": [{
        ...
        "schema": {
          "type": "object",
          "properties": {"id": {"$ref": "#/definitions/merchantProfiles/definitions/id"}},
          "required": ["id"]
        },
    ...
    "merchants": {
      ...
      "links": [{
        ...
        "authenticated": true,
        "description": "I get an merchant summary",
        "href": "/merchants/{(%23%2Fdefinitions%2Fmerchants%2Fdefinitions%2Fid)}/summary",
        "method": "GET",
        "rel": "summary",
        "schema": {
          "type": "object",
      ...
      "definitions": {
        ...
        "recurringPlan": {
          ...
          "definitions": {
            ...
            "intervalLength": {
              "description": "the length of the interval unit",
              "example": 5,
              "type": ["integer", "string"]
            },
            "amount": {
            ...
            "initialFee": {
              "description": "the initial fee to apply before the recurring payment",
              "example": 4.99,
              "type": ["number", "string"]
            }
          },
    ...
    "orders": {
      ...
      "definitions": {
        ...
        "ipAddress": {
          ...
          "example": "{ip: '127.0.0.1', geolocalisation: {country: 'FR'}}",
          "type": "object"
        },
      ...
      "links": [{
        ...
        "schema": {
          "type": "object",
          "properties": {
            "gatewayId": {"$ref": "#/definitions/banks/definitions/id"},
            ...
            "originalAmount": {"$ref": "#/definitions/orders/definitions/original_amount"},
            "convertedAmount": {"$ref": "#/definitions/orders/definitions/converted_amount"},
            "gatewayResponse": {"$ref": "#/definitions/orders/definitions/gateway_response"},
            "ipAddress": {"$ref": "#/definitions/orders/definitions/ipAddress"},
            "transaction_id": {"$ref": "#/definitions/orders/definitions/transaction_id"},
            "referer": {"$ref": "#/definitions/orders/definitions/referer"},
            "channels": {"$ref": "#/definitions/orders/definitions/channels"},
          ...
          "required": ["prospectId", "offerId", "originalAmount", "convertedAmount"]
        },
        "targetSchema": {"$ref": "#/definitions/orders"}
      }, {
        "authenticated": true,
        ...
        "schema": {
          ...
          "properties": {
            ...
            "billing_status": "#/definitions/orders/definitions/billing_status",
            "shippingAddress": {
              "type": "object",
              "properties": {
        ...
        "authenticated": true,
        "description": "get the list of pixels related to an order",
        "href": "/orders/{(%23%2Fdefinitions%2Forders%2Fdefinitions%2Fid)}/pixels",
        "method": "GET",
        "rel": "get order pixels",
        "schema": {
          "type": "object",
          "properties": {"id": {"$ref": "#/definitions/orders/definitions/id"}},
          "required": ["id"]
        },
        "targetSchema": {"type": "array", "items": {"$ref": "#/definitions/pixels"}}
      }, {
        "authenticated": true,
        "description": "get the list of tags associated to an order",
        "href": "/orders/{(%23%2Fdefinitions%2Forders%2Fdefinitions%2Fid)}/tags",
        "method": "GET",
        "rel": "tags",
        "schema": {
          "type": "object",
        ...
        "schema": {
          "type": "object",
          "properties": {
            "tags": {"type": "array", "items": {"$ref": "#/definitions/tags/definitions/title"}},
            "id": {"$ref": "#/definitions/orders/definitions/id"}
          },
          "required": ["id"]
        },
    ...
    "pixels": {
      ...
      "definitions": {
        ...
        "fired": {
          "description": "a flag which tells whether the tracker has been fired or not",
          "example": true,
          "type": ["string", "boolean"]
        },
        "mapValues": {
      ...
      "links": [{
        ...
        "schema": {
          "type": "object",
          "properties": {"id": {"$ref": "#/definitions/pixels/definitions/id"}},
          "required": ["id"]
        },
    ...
    "shippingOffers": {
      ...
      "links": [{
        ...
        "rel": "destroy",
        "schema": {
          "properties": {"id": {"$ref": "#/definitions/shippingOffers/definitions/id"}},
          "required": ["id"],
          "type": "object"
        }
      }]
    ...
    "subscriptions": {
      ...
      "definitions": {
        ...
        "intervalLength": {
          "description": "the length of the time unit between two payments",
          "type": ["integer", "string"],
          "example": 4
        },
        "intervalUnit": {
      ...
      "links": [{
        ...
        "schema": {
          ...
          "properties": {
            ...
            "include": {
              "description": "the related resource to include",
              "type": ["array"],
              "items": {"type": "string", "enum": ["prospect", "bank", "campaign", "offer"]}
            }
          }
        },
        "targetSchema": {
          ...
          "properties": {
            "count": {"type": "integer"},
            "rows": {"type": "array", "items": {"$ref": "#/definitions/subscriptions"}}
          }
        }
      }, {
        "authenticated": true,
        ...
        "schema": {
          "anyOf": [{
            ...
            "properties": {
              "offerId": {"$ref": "#/definitions/offers/definitions/id"},
              "customerId": {"$ref": "#/definitions/prospects/definitions/id"},
            ...
            "required": ["offerId", "customerId", "paymentId", "billingAddressId", "shippingAddressId", "shippingOfferId"]
          }]
        },
        "targetSchema": {"$ref": "#/definitions/subscriptions"}
      }, {
    ...
    "tags": {
      ...
      "definitions": {
        ...
        "description": {
          "description": "the human readable description of the tag",
          "example": "means the item is a result a bonus",
          "type": "string"
        }
      },
      "properties": {
      ...
      "links": [{
        ...
        "targetSchema": {
          "count": {"type": "integer", "minimum": 0},
          "rows": {"type": "array", "items": {"$ref": "#/definitions/tags"}},
          "type": "object"
        }
      }, {
        "authenticated": true,
        ...
        "rel": "destroy",
        "schema": {
          "properties": {"id": {"$ref": "#/definitions/tags/definitions/id"}},
          "required": ["id"],
          "type": "object"
        }
      }]
    ...
    "trackers": {
      ...
      "definitions": {
        ...
        "type": {
          ...
          "example": "image",
          "type": "string",
          "enum": ["image", "javascript", "snippet", "postback"]
        },
      ...
      "links": [{
        ...
        "description": "I fire a postback tracker",
        "href": "test/trackers/convert",
        "method": "POST",
        "rel": "fire",
        "schema": {"type": "object"}
      }]
