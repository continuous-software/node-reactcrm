module.exports = {
  ...
  "type": ["object"],
  "id": "http://localhost:8001/public/schema.json",
  "links": [{"href": "http://localhost:8001", "rel": "self"}],
  "title": "REACT CRM API",
  "properties": {
    ...
    "banks": {
      ...
      "definitions": {
        ...
        "type": {
          ...
          "example": "Paypal",
          "type": "string",
          "enum": ["rocketgate", "virtualmerchant", "authorizenet", "payflow", "nmi", "stripe", "braintree", "omise"]
        },
        "authorizeNet": {
      ...
      "links": [{
        ...
        "schema": {
          ...
          "properties": {
            "search": {"type": "object"},
            "orderBy": {"type": "string"},
            "orderReverse": {"type": ["string", "boolean", "null"]},
            "itemsByPage": {"type": ["integer", "string"]},
        ...
        "targetSchema": {
          "type": "object",
          "count": {"type": "integer", "minimum": 0},
          "rows": {"type": "array", "items": {"$ref": "#/definitions/orders"}}
        }
      }, {
        "authenticated": true,
