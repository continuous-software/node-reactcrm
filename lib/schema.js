    ...
    "banks": {
      ...
      "definitions": {
        ...
        "type": {
          ...
          "example": "Paypal",
          "type": "string",
          "enum": ["rocketgate", "virtualmerchant", "authorizenet", "payflow", "nmi", "stripe", "braintree", "omise", "paypal"]
        },
        "authorizeNet": {
    ...
    "orders": {
      ...
      "links": [{
        ...
        "schema": {
          ...
          "required": ["gateway_id", "campaign_id", "prospect_id", "shippingOfferId", "offer_id", "billing_status", "creditcard", "original_amount", "converted_amount", "gateway_response", "shippingAddressId", "billingAddressId"]
        },
        "targetSchema": {"$ref": "#/definitions/orders"}
      }, {
        "authenticated": true,
