...
ReactCRM.prototype.getStoreFront = function (reload) {
  console.warn('"getStoreFront" is deprecated, will be removed in 3.0.0. Use namespace api instead');
  var service = this;
...
ReactCRM.prototype.saveProspect = function saveProspect (prospect) {
  console.warn('"saveProspect" is deprecated, will be removed in 3.0.0. Use namespace api instead');
  var service = this;
...
ReactCRM.prototype.getOrder = function getOrder (id) {
  console.warn('"getOrder" is deprecated, will be removed in 3.0.0. Use namespace api instead');
  return this.api.orders.self(id);
};

ReactCRM.prototype.incrementVisits = function updateStoreFront (n) {
  console.warn('"updateStoreFront" is deprecated, will be removed in 3.0.0. Use namespace api instead');
  var number = n || 1;
  var service = this;
...
ReactCRM.prototype.addOrder = function addOrder (order) {
  console.warn('"addOrder" is deprecated, will be removed in 3.0.0. Use namespace api instead');
  var service = this;
  return this.getStoreFront()
    .then(function (campaign) {
